...
pub fn load_trial<const S: usize>(keys: &mut Keys<S>) {
    // Layer 0
    ...
    keys.set_modcomb(
        KeyCodes::KeyboardAa,
        [Some(KeyCodes::KeyboardLeftGUI), None, None, None],
    ...
    keys.set_modcomb(
        KeyCodes::KeyboardSs,
        [Some(KeyCodes::KeyboardLeftControl), None, None, None],
        [Some(10), None, None, None],
        8,
        0,
    );
    keys.set_modcomb(
        KeyCodes::KeyboardDd,
        [Some(KeyCodes::KeyboardLeftShift), None, None, None],
        [Some(10), None, None, None],
        9,
        0,
    );
    keys.set_modcomb(
        KeyCodes::KeyboardFf,
        [
            Some(KeyCodes::KeyboardLeftShift),
            Some(KeyCodes::KeyboardLeftControl),
            Some(KeyCodes::KeyboardLeftGUI),
            None,
        ],
    ...
    keys.set_code(KeyCodes::KeyboardEscape, 18, 0);
    ...
    keys.set_modcomb(
        KeyCodes::KeyboardJj,
        [
            Some(KeyCodes::KeyboardRightShift),
            Some(KeyCodes::KeyboardRightControl),
            Some(KeyCodes::KeyboardRightGUI),
            None,
        ],
        [Some(29), Some(30), Some(31), None],
        28,
        0,
    );
    keys.set_modcomb(
        KeyCodes::KeyboardKk,
        [Some(KeyCodes::KeyboardRightShift), None, None, None],
    ...
    keys.set_modcomb(
        KeyCodes::KeyboardLl,
        [Some(KeyCodes::KeyboardRightControl), None, None, None],
        [Some(28), None, None, None],
        30,
        0,
    );
    keys.set_modcomb(
        KeyCodes::KeyboardSemiColon,
        [Some(KeyCodes::KeyboardRightGUI), None, None, None],
        [Some(28), None, None, None],
        31,
        0,
    );
    ...
    keys.set_code(KeyCodes::KeyboardBackspace, 41, 0);

    // Layer 1 (Function and Arrow key layer)
    keys.set_code(KeyCodes::KeyboardF1, 21, 1);
    keys.set_code(KeyCodes::KeyboardF2, 22, 1);
    keys.set_code(KeyCodes::KeyboardF3, 23, 1);
    keys.set_code(KeyCodes::KeyboardF4, 24, 1);
    keys.set_code(KeyCodes::KeyboardF5, 25, 1);

    keys.set_code(KeyCodes::KeyboardF6, 27, 1);
    ...
    keys.set_code(KeyCodes::KeyboardF7, 33, 1);
    keys.set_code(KeyCodes::KeyboardF8, 34, 1);
    keys.set_code(KeyCodes::KeyboardF9, 35, 1);
    keys.set_code(KeyCodes::KeyboardF10, 36, 1);
    keys.set_code(KeyCodes::KeyboardF11, 37, 1);

    keys.set_code(KeyCodes::KeyboardEnter, 39, 1);
    keys.set_code(KeyCodes::KeyboardF12, 40, 1);
    keys.set_code(KeyCodes::KeyboardBackspace, 41, 1);

    // Layer 2 (Number Layer)
    keys.set_code(KeyCodes::KeyboardOpenBracketBrace, 1, 2);
    keys.set_code(KeyCodes::Keyboard7Ampersand, 2, 2);
    keys.set_code(KeyCodes::Keyboard8Asterisk, 3, 2);
    keys.set_code(KeyCodes::Keyboard9OpenParens, 4, 2);
    keys.set_code(KeyCodes::KeyboardCloseBracketBrace, 5, 2);

    keys.set_code(KeyCodes::KeyboardSingleDoubleQuote, 7, 2);
    keys.set_code(KeyCodes::Keyboard4Dollar, 8, 2);
    keys.set_code(KeyCodes::Keyboard5Percent, 9, 2);
    keys.set_code(KeyCodes::Keyboard6Caret, 10, 2);
    keys.set_code(KeyCodes::KeyboardEqualPlus, 11, 2);

    keys.set_code(KeyCodes::KeyboardBacktickTilde, 13, 2);
    keys.set_code(KeyCodes::Keyboard1Exclamation, 14, 2);
    keys.set_code(KeyCodes::Keyboard2At, 15, 2);
    keys.set_code(KeyCodes::Keyboard3Hash, 16, 2);
    keys.set_code(KeyCodes::KeyboardBackslashBar, 17, 2);

    keys.set_code(KeyCodes::KeyboardPeriodGreater, 18, 2);
    keys.set_code(KeyCodes::Keyboard0CloseParens, 19, 2);
    keys.set_code(KeyCodes::KeyboardDashUnderscore, 20, 2);

    keys.set_code(KeyCodes::KeyboardRightShift, 30, 2);
